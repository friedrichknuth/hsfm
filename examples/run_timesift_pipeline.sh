...
python hsfm/timesift/preprocessing.py \
    --output-directory "/data2/elilouis/mt_baker_timesift_cam_calib/" \
...
python hsfm/timesift/timesift.py \
    --metashape-metadata-file   "/data2/elilouis/mt_baker_timesift_cam_calib/metashape_metadata.csv" \
    --image-metadata-file       "/data2/elilouis/mt_baker_timesift_cam_calib/image_metadata.csv" \
    --raw-images-directory      "/data2/elilouis/mt_baker_timesift_cam_calib/preprocessed_images/" \
    --output-directory          "/data2/elilouis/mt_baker_timesift_cam_calib/" \
