...
python hsfm/timesift/timesift.py \
    ...
    --pixel-pitch               0.02 \
    --parallelization           2 \
    --reference-dem-4d          /data2/elilouis/hsfm-geomorph/data/reference_dem_highres/adams/2016_10m.tif \
...
python hsfm/timesift/timesift.py \
    ...
    --pixel-pitch               0.02 \
    --parallelization           1 \
    --reference-dem-4d          /data2/elilouis/hsfm-geomorph/data/reference_dem_highres/hood/2009_10m.tif \
